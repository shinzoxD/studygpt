...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 w-[min(92vw,40rem)] -translate-x-1/2 -translate-y-1/2 rounded-[1.8rem] border border-border bg-popover p-6 shadow-[0_18px_80px_-28px_rgba(0,0,0,0.55)]",
        className,
      )}
      {...props}
    >
